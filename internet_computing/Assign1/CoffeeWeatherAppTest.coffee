...
exports.testGeneratPathForHttpRequest = (test) ->
	test.equal '/forecastrss?w=2499999&u=f', coffeeWeatherApp.generatePathForHttpRequest 2499999
	test.done()

exports.testGenerateHttpOptionsForHttpRequest = (test) ->
...
exports.testParseDataFromWebRequest = (test) ->
...
exports.testParseDataFromWebRequestWhenWOEIDDoesntExist = (test) ->
...
exports.testGetErrorFromHttpRequest = (test) ->
	...
	handlerFunc = (error, content) ->
		...
		test.done()
	coffeeWeatherApp.getHttpResponse httpOptions, handlerFunc

isANumber = (objectToTest) ->
	return !isNaN objectToTest

exports.testGetCityAndStateFromHttpRequest = (test) ->
	path = coffeeWeatherApp.generatePathForHttpRequest 2499999
	httpOptions = coffeeWeatherApp.generateHttpOptionsForHttpRequest path
	handlerFunc = (error, content) ->
...
exports.testGetMultipleCitiesAndStatesFromHttpRequest = (test) ->
	...
	weatherInfoHandler = (error, content) ->
	...
	coffeeWeatherApp.getWeatherInfoFromWOEIDS WOEIDSToTest, weatherInfoHandler